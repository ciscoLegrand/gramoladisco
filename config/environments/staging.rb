...
Rails.application.configure do
  ...
  if Rails.application.credentials.rails_log_to_stdout
  ...
  config.active_job.queue_name_prefix = "gramoladisco_staging"

  config.action_mailer.perform_caching = false
  config.action_mailer.default_url_options = { host: 'staging.lagramoladisco.com' }
